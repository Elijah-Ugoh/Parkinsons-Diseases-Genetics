...
legend("bottomright",col=c("green3","red","blue","cyan"),pch=16,c("Africa","Asia","New samples","Europe"))
dev.off()
...
pdf("mixed_confirmation_plot.pdf")
plot(total$V4,total$V5,pch=16,col=total$V1)
legend("topleft",col=c("green3","red","blue","black"),pch=16,c("Africa","Asia","Mixed samples","Europe"))
dev.off()
